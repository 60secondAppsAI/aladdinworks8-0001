...
<template>
  ...
  <base-input label="PowerOutput" type="text" placeholder="Enter PowerOutput" v-model="generatorToAdd.powerOutput"></base-input>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'powerOutput',
          visible: true,
          scopedSlots: { customRender: 'powerOutput' },
          sorter: true
          //sorter: (a, b) => a.powerOutput - b.powerOutput,
          //sorter: (a, b) => a.powerOutput.localeCompare(b.powerOutput),
        },
        {
          title: 'Fuel Type',
		dataIndex: 'fuelType',
