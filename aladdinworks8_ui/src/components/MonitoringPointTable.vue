...
<template>
  ...
  <base-input label="CurrentValue" type="text" placeholder="Enter CurrentValue" v-model="monitoringPointToAdd.currentValue"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'currentValue',
          ...
          //sorter: (a, b) => a.currentValue.localeCompare(b.currentValue),
        },
      ],
      pagination: {
        current: 1,
