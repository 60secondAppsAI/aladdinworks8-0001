...
<template>
  ...
  <base-input label="NumberOfSockets" type="text" placeholder="Enter NumberOfSockets" v-model="powerStripToAdd.numberOfSockets"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'numberOfSockets',
          visible: true,
          scopedSlots: { customRender: 'numberOfSockets' },
          sorter: true
          //sorter: (a, b) => a.numberOfSockets - b.numberOfSockets,
          //sorter: (a, b) => a.numberOfSockets.localeCompare(b.numberOfSockets),
        },
      ],
      pagination: {
        current: 1,
