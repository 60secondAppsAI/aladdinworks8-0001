...
<template>
  ...
  <base-input label="Wattage" type="text" placeholder="Enter Wattage" v-model="powerSupplyToAdd.wattage"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'wattage',
          visible: true,
          scopedSlots: { customRender: 'wattage' },
          sorter: true
          //sorter: (a, b) => a.wattage - b.wattage,
          //sorter: (a, b) => a.wattage.localeCompare(b.wattage),
        },
      ],
      pagination: {
        current: 1,
