...
<template>
  ...
  <base-input label="RackNumber" type="text" placeholder="Enter RackNumber" v-model="rackToAdd.rackNumber"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'rackNumber',
          visible: true,
          scopedSlots: { customRender: 'rackNumber' },
          sorter: true
          //sorter: (a, b) => a.rackNumber - b.rackNumber,
          //sorter: (a, b) => a.rackNumber.localeCompare(b.rackNumber),
        },
      ],
      pagination: {
        current: 1,
